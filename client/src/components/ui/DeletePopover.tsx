...
function DeletePopover({ title, itemName, onConfirm, onCancel }: DeletePopoverProps) {
  ...
  return (
    <div
      ref={ref}
      className="absolute bottom-full right-0 mb-2 z-10 bg-white border border-slate-200 rounded-xl shadow-lg w-56"
    >
      ...
      <div className="border-t border-slate-100 px-4 py-2.5 flex justify-end gap-2">
        <button
          onClick={onCancel}
